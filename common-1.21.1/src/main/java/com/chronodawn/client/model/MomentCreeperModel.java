 ...
 */
public class MomentCreeperModel extends EntityModel<MomentCreeperEntity> {
    ...
    @Override
    public void setupAnim(MomentCreeperEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        // Head rotation
