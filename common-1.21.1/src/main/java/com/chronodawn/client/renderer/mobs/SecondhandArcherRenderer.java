 ...
 */
public class SecondhandArcherRenderer extends MobRenderer<SecondhandArcherEntity, SecondhandArcherModel> {
    ...
    @Override
    public ResourceLocation getTextureLocation(SecondhandArcherEntity entity) {
        return TEXTURE;
    }
}
