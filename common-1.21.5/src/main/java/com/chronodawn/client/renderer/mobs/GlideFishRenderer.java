 ...
 */
public class GlideFishRenderer extends MobRenderer<GlideFishEntity, GlideFishRenderState, GlideFishModel> {
    ...
    @Override
    public GlideFishRenderState createRenderState() {
        return new GlideFishRenderState();
    }

    @Override
    public ResourceLocation getTextureLocation(GlideFishRenderState state) {
        return TEXTURE;
    }
}
