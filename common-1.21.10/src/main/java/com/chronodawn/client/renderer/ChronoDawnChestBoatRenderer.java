...
public class ChronoDawnChestBoatRenderer extends EntityRenderer<ChronoDawnChestBoat, ChronoDawnChestBoatRenderState> {
    ...
    @Override
    public void submit(ChronoDawnChestBoatRenderState state, PoseStack poseStack,
        ...
        if (!state.isUnderWater) {
            collector.submitModel(this.waterPatchModel, state, poseStack, RenderType.waterMask(), 0xF000F0, net.minecraft.client.renderer.texture.OverlayTexture.NO_OVERLAY, 0xFFFFFFFF, null);
        }
