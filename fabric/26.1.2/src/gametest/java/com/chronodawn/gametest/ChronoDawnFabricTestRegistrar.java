...
/**
 * Registers the registry-driven GameTests on Fabric for Minecraft 26.1.2.
 *
 ...
 *
 * <p>26.1.2: {@code TestEnvironmentDefinition} became generic
 * ({@code TestEnvironmentDefinition<SavedDataType>}), so {@code FunctionGameTestInstance} now
 * takes {@code TestData<Holder<TestEnvironmentDefinition<?>>>} instead of the raw-typed
 * {@code TestData<Holder<TestEnvironmentDefinition>>} the shared 1.21.5+ copy of this class uses.
 * This copy adds the {@code <?>} wildcard to match.
 */
public final class ChronoDawnFabricTestRegistrar implements ModInitializer {
    ...
    private static void registerTestInstances(DynamicRegistryView view) {
        ...
        // Declared as Holder<TestEnvironmentDefinition<?>>, not the Holder.Reference that
        // registerForHolder returns, so that TestData infers the type parameter
        // FunctionGameTestInstance expects.
