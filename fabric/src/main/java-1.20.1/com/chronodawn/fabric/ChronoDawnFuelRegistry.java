...
public class ChronoDawnFuelRegistry {
    ...
    public static void register() {
        ...
        ChronoDawn.LOGGER.info("Registered fuel items for Fabric using tags");
    }
    ...
    private static void registerTagFuel(FuelRegistry registry, String tagId, int burnTime) {
        // 1.20.1: Use new ResourceLocation() constructor
        String[] parts = tagId.split(":");
        ResourceLocation tagLocation = new ResourceLocation(parts[0], parts[1]);
