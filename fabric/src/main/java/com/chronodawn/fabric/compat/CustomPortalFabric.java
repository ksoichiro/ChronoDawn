package com.chronodawn.fabric.compat;
 ...
 * the ChronoDawn portal functionality on Fabric.
 *
...
public class CustomPortalFabric {
     ...
     * to register the ChronoDawn portal with Custom Portal API.
     */
    public static void init() {
        ChronoDawn.LOGGER.info("Initializing Custom Portal API integration (Fabric)");
        ...
        ChronoDawn.LOGGER.info("ChronoDawn portal registered with Custom Portal API");
