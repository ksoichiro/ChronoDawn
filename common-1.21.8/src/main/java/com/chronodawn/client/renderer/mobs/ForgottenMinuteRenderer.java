 ...
 */
public class ForgottenMinuteRenderer extends MobRenderer<ForgottenMinuteEntity, ForgottenMinuteRenderState, ForgottenMinuteModel> {
    ...
    @Override
    public ForgottenMinuteRenderState createRenderState() {
        return new ForgottenMinuteRenderState();
    }
    ...
    @Override
    public ResourceLocation getTextureLocation(ForgottenMinuteRenderState state) {
        return TEXTURE;
    }
}
