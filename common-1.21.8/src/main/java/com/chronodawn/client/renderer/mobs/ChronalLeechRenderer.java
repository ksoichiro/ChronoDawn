 ...
 */
public class ChronalLeechRenderer extends MobRenderer<ChronalLeechEntity, ChronalLeechRenderState, ChronalLeechModel> {
    ...
    @Override
    public ChronalLeechRenderState createRenderState() {
        return new ChronalLeechRenderState();
    }

    @Override
    public void extractRenderState(ChronalLeechEntity entity, ChronalLeechRenderState state, float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        // No additional state extraction needed for basic rendering
    }

    @Override
    public ResourceLocation getTextureLocation(ChronalLeechRenderState state) {
        return TEXTURE;
    }
}
