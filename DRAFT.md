# マインクラフト Mod 仕様書：クロノスフィアの残響 (Echoes of the Chronosphere)

## 1. Mod 概要

* タイトル: クロノスフィアの残響 (Echoes of the Chronosphere)
* テーマ: 時間の流れが停止し、歪んだ世界「クロノスフィア」からの脱出と、時間の力の制御。
...
2. **「不安定な門」:** **時の砂時計**を使用してポータルを起動しクロノスフィアへ。突入直後、ポータルが時間の歪みにより**機能停止**する。
...
3. **「クロノスフィアの解放者」:** 報酬として**「クロノスの瞳」**を獲得し、クロノスフィアの世界が安定（特殊なMobやブロックが安定供給される）し、自由に行き来が可能となる。

## 3. ディメンション：クロノスフィアの特性と挙動（低負荷実装）
...
| クロノスの瞳 | 究極アーティファクト | (最終報酬) 獲得後、クロノスフィアのMobの基本遅延効果がさらに強化される（安定化）。 | ディメンション全体の環境を永続的に変化させる。 |
