 ...
 *
 * A mechanical guardian immune to time distortion effects. Moves at normal speed unlike other ChronoDawn mobs.
 *
 * Attributes:
 * - Health: 30 (15 hearts)
 ...
 *
 * Spawn Conditions:
 * - Biomes: chronodawn_plains, chronodawn_forest, chronodawn_desert (all land biomes)
...
public class ClockworkSentinelEntity extends Monster {
     ...
     *
     * This makes Clockwork Sentinel a unique threat in ChronoDawn, as it moves at normal speed
    ...
    public boolean canBeAffected(net.minecraft.world.effect.MobEffectInstance effect) {
        ...
        if (effect.getEffect() == net.minecraft.world.effect.MobEffects.SLOWNESS) {
            return false;
        }
