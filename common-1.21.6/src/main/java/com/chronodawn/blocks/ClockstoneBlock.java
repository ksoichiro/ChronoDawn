...
public class ClockstoneBlock extends Block {
    ...
    /**
     * Called after this block is removed to affect neighbors.
     * In 1.21.5, onRemove was replaced with affectNeighborsAfterRemoval.
     * This method handles side effects like destroying connected portal blocks.
     */
    @Override
