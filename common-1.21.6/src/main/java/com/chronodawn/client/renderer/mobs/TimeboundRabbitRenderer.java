 ...
 */
public class TimeboundRabbitRenderer extends MobRenderer<TimeboundRabbitEntity, TimeboundRabbitRenderState, TimeboundRabbitModel> {
    ...
    @Override
    public TimeboundRabbitRenderState createRenderState() {
        return new TimeboundRabbitRenderState();
    }

    @Override
    public void extractRenderState(TimeboundRabbitEntity entity, TimeboundRabbitRenderState state, float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        state.jumpRotation = entity.getJumpCompletion(partialTick);
    }

    @Override
    public ResourceLocation getTextureLocation(TimeboundRabbitRenderState state) {
        return TEXTURE;
    }
}
