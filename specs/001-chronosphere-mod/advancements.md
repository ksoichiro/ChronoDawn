# Chronosphere Mod - Advancement System Specification

**Created**: 2025-11-16
**Status**: Draft
**Purpose**: Define all advancements (achievements) for Chronosphere Mod to track player progression and provide clear goals
...
│   ├── dimension_entry (Enter Chronosphere) [depends: portal_creation]
...
│   └── all_biomes_explored (Explore all Chronosphere biomes) [challenge] [depends: dimension_entry]
└── Mob Encounters
...
#### `root.json` - Chronosphere
- **ID**: `chronosphere:root`
- **English Title**: "Chronosphere"
- **Japanese Title**: "クロノスフィア"
...
- **Frame**: `task`
- **Icon**: `chronosphere:clockstone`
- **Background**: `chronosphere:textures/block/chronosphere_stone.png`
- **Show Toast**: `true`
...
- **ID**: `chronosphere:portal_creation`
- **English Title**: "A Gateway Through Time"
- **Japanese Title**: "時を超える門"
- **English Description**: "Craft a Time Hourglass to create a portal to the Chronosphere"
- **Japanese Description**: "時の砂時計を作成し、クロノスフィアへの扉を開く"
- **Trigger**: `inventory_changed` (obtain Time Hourglass)
- **Parent**: `chronosphere:root`
- **Frame**: `task`
- **Icon**: `chronosphere:time_hourglass`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `dimension_entry.json` - Entering the Frozen World
- **ID**: `chronosphere:dimension_entry`
- **English Title**: "Entering the Frozen World"
- **Japanese Title**: "凍結した世界へ"
- **English Description**: "Enter the Chronosphere dimension for the first time"
- **Japanese Description**: "初めてクロノスフィア次元に突入する"
- **Trigger**: `changed_dimension` (to `chronosphere:chronosphere`)
- **Parent**: `chronosphere:portal_creation`
- **Frame**: `goal`
- **Icon**: `chronosphere:chronosphere_stone`
- **Show Toast**: `true`
- **Announce to Chat**: `true`
- **Hidden**: `false`

#### `forgotten_library.json` - Archives of Lost Time
- **ID**: `chronosphere:forgotten_library`
...
- **Trigger**: `location` (structure: `chronosphere:forgotten_library`)
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
...
- **ID**: `chronosphere:portal_stabilization`
...
- **Parent**: `chronosphere:forgotten_library`
- **Frame**: `goal`
- **Icon**: `chronosphere:portal_stabilizer`
- **Show Toast**: `true`
- **Announce to Chat**: `true`
- **Hidden**: `false`
...
- **ID**: `chronosphere:desert_clock_tower`
...
- **Trigger**: `location` (structure: `chronosphere:desert_clock_tower`)
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
- **Icon**: `chronosphere:enhanced_clockstone`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_manipulation_tools.json` - Tools of Temporal Control
- **ID**: `chronosphere:time_manipulation_tools`
...
- **Parent**: `chronosphere:desert_clock_tower`
- **Frame**: `task`
- **Icon**: `chronosphere:time_clock`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_guardian_defeat.json` - Vanquisher of the Guardian
- **ID**: `chronosphere:time_guardian_defeat`
...
- **Trigger**: `player_killed_entity` (entity: `chronosphere:time_guardian`)
- **Parent**: `chronosphere:time_manipulation_tools`
- **Frame**: `goal`
- **Icon**: `chronosphere:master_clock_key`
- **Show Toast**: `true`
- **Announce to Chat**: `true`
- **Hidden**: `false`
...
- **ID**: `chronosphere:master_clock_access`
...
- **Trigger**: `location` (structure: `chronosphere:master_clock`)
- **Parent**: `chronosphere:time_guardian_defeat`
- **Frame**: `task`
- **Icon**: `chronosphere:master_clock_key`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
...
#### `time_tyrant_defeat.json` - Liberator of Chronosphere
- **ID**: `chronosphere:time_tyrant_defeat`
- **English Title**: "Liberator of Chronosphere"
- **Japanese Title**: "クロノスフィアの解放者"
- **English Description**: "Defeat the Time Tyrant and shatter the Stasis Core"
- **Japanese Description**: "時間の暴君を倒し、静止のコアを破壊する"
- **Trigger**: `player_killed_entity` (entity: `chronosphere:time_tyrant`)
- **Parent**: `chronosphere:master_clock_access`
- **Frame**: `challenge`
- **Icon**: `chronosphere:chronos_eye`
- **Show Toast**: `true`
- **Announce to Chat**: `true`
- **Hidden**: `false`

#### `ultimate_artifacts.json` - Master of Time
- **ID**: `chronosphere:ultimate_artifacts`
...
- **Parent**: `chronosphere:time_tyrant_defeat`
- **Frame**: `challenge`
- **Icon**: `chronosphere:chronoblade`
- **Show Toast**: `true`
- **Announce to Chat**: `true`
- **Hidden**: `false`
...
- **Trigger**: `consume_item` (item: `chronosphere:time_fruit_pie`)
- **Parent**: `chronosphere:first_time_fruit`
- **Frame**: `task`
- **Icon**: `chronosphere:time_fruit_pie`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_jam.json` - Sweet Temporal Spread
- **ID**: `chronosphere:time_jam`
- **English Title**: "Sweet Temporal Spread"
- **Japanese Title**: "甘美な時の広がり"
- **English Description**: "Eat Time Jam"
- **Japanese Description**: "時のジャムを食べる"
- **Trigger**: `consume_item` (item: `chronosphere:time_jam`)
- **Parent**: `chronosphere:first_time_fruit`
- **Frame**: `task`
- **Icon**: `chronosphere:time_jam`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_bread.json` - Bread from a Frozen Age
- **ID**: `chronosphere:time_bread`
...
- **Trigger**: `consume_item` (item: `chronosphere:time_bread`)
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
- **Icon**: `chronosphere:time_bread`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `all_foods_consumed.json` - Gourmet of Time
- **ID**: `chronosphere:all_foods_consumed`
- **English Title**: "Gourmet of Time"
- **Japanese Title**: "時のグルメ"
- **English Description**: "Eat all custom Chronosphere foods (Time Fruit, Time Fruit Pie, Time Jam, Time Bread)"
- **Japanese Description**: "クロノスフィアの全てのカスタム食料を食べる（時間の果実、時の果実パイ、時のジャム、時のパン）"
- **Trigger**: Custom (composite trigger tracking all 4 foods)
- **Parent**: `chronosphere:time_fruit_pie`, `chronosphere:time_jam`, `chronosphere:time_bread`
- **Frame**: `challenge`
...
- **ID**: `chronosphere:tier1_full_set`
...
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
- **Icon**: `chronosphere:clockstone_chestplate`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `tier2_full_set.json` - Enhanced Temporal Armor
- **ID**: `chronosphere:tier2_full_set`
...
- **Parent**: `chronosphere:desert_clock_tower`
- **Frame**: `task`
- **Icon**: `chronosphere:enhanced_clockstone_chestplate`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_distortion_immunity.json` - Beyond Time's Grasp
- **ID**: `chronosphere:time_distortion_immunity`
...
- **Parent**: `chronosphere:tier2_full_set`
- **Frame**: `goal`
...
- **ID**: `chronosphere:first_time_crystal_ore`
...
- **Trigger**: `item_used_on_block` (item: pickaxe, block: `chronosphere:time_crystal_ore`)
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
- **Icon**: `chronosphere:time_crystal`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `all_biomes_explored.json` - Temporal Cartographer
- **ID**: `chronosphere:all_biomes_explored`
- **English Title**: "Temporal Cartographer"
- **Japanese Title**: "時間の地図製作者"
- **English Description**: "Explore all Chronosphere biomes (Plains, Desert, Forest, Mountain, Swamp, Snowy, Cave)"
- **Japanese Description**: "クロノスフィアの全バイオームを探索する（平原、砂漠、森林、山岳、沼地、雪原、洞窟）"
...
- **ID**: `chronosphere:clockwork_sentinel_defeated`
...
- **Trigger**: `player_killed_entity` (entity: `chronosphere:clockwork_sentinel`)
- **Parent**: `chronosphere:dimension_entry`
- **Frame**: `task`
- **Icon**: `chronosphere:ancient_gear`
- **Show Toast**: `true`
- **Announce to Chat**: `false`
- **Hidden**: `false`

#### `time_keeper_trade.json` - Temporal Merchant
- **ID**: `chronosphere:time_keeper_trade`
...
Chronosphere advancements use the following trigger types:
...
```json
{
  "advancements.chronosphere.root.title": "Chronosphere",
  "advancements.chronosphere.root.description": "Welcome to the world of time manipulation"
}
```
...
```
common/src/main/resources/data/chronosphere/advancements/
```
...
- **No Time to Waste**: Defeat Time Tyrant without dying in Chronosphere
- **Temporal Archaeologist**: Discover all structures (Ancient Ruins, Forgotten Library, Desert Clock Tower, Master Clock)
- **Master Craftsman**: Craft all Chronosphere items at least once
- **Mob Encyclopedia**: Defeat at least 1 of each Chronosphere mob type
