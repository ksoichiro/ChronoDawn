...
- `fabric/1.21.2/build/libs/chronodawn-0.7.0+1.21.2-fabric.jar` - Fabric loader JAR
- `neoforge/1.21.2/build/libs/chronodawn-0.7.0+1.21.2-neoforge.jar` - NeoForge loader JAR
...
5. Copy `chronodawn-0.7.0+1.21.2-fabric.jar` to `.minecraft/mods/` folder
...
4. Copy `chronodawn-0.7.0+1.21.2-neoforge.jar` to `.minecraft/mods/` folder
