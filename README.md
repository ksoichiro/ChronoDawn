...
**Output Files**:
- `fabric/build/libs/chronodawn-0.2.0-beta+1.21.1-fabric.jar` - Fabric loader JAR
- `neoforge/build/libs/chronodawn-0.2.0-beta+1.21.1-neoforge.jar` - NeoForge loader JAR
- `common/build/libs/common-0.2.0-beta.jar` - Common module (not usable standalone)
...
5. Copy `chronodawn-0.2.0-beta+1.21.1-fabric.jar` to `.minecraft/mods/` folder
...
4. Copy `chronodawn-0.2.0-beta+1.21.1-neoforge.jar` to `.minecraft/mods/` folder
