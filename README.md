...
- **1.21.10**: NeoForge/Fabric (current version, default)

### Build for Specific Minecraft Version

#### Build for Minecraft 1.21.10 (Default)
```bash
...
```bash
# Build all release versions (1.20.1, 1.21.1, 1.21.2, 1.21.4, 1.21.5, 1.21.6, 1.21.7, 1.21.8, 1.21.9, 1.21.10)
...
├── common-1.21.10/                  # Common module for MC 1.21.10 (~80% of code)
