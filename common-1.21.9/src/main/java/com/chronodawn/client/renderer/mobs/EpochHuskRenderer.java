 ...
 */
public class EpochHuskRenderer extends MobRenderer<EpochHuskEntity, EpochHuskRenderState, EpochHuskModel> {
    ...
    @Override
    public EpochHuskRenderState createRenderState() {
        return new EpochHuskRenderState();
    }
    ...
    @Override
    public ResourceLocation getTextureLocation(EpochHuskRenderState state) {
        return TEXTURE;
    }
}
