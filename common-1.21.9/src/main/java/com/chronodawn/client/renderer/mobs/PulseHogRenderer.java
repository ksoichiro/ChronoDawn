 ...
 */
public class PulseHogRenderer extends MobRenderer<PulseHogEntity, PulseHogRenderState, PulseHogModel> {
    ...
    @Override
    public PulseHogRenderState createRenderState() {
        return new PulseHogRenderState();
    }

    @Override
    public ResourceLocation getTextureLocation(PulseHogRenderState state) {
        return TEXTURE;
    }
}
