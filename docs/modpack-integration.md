...
| `#chronodawn:portal_stabilizers` | item | `chronodawn:portal_stabilizer` | Items that stabilize a deactivated Chrono Dawn portal for bidirectional travel when used on its Clockstone frame |
