...
- A new dimension with **11 unique biomes**
...
1. **Architectury API** - Required for both loaders
   ...
   - Version 18.0.3+ for Minecraft 1.21.9
   - Version 17.0.8+ for Minecraft 1.21.7/1.21.8
   - Version 17.0.6+ for Minecraft 1.21.6
   - Version 16.1.4+ for Minecraft 1.21.5
...
4. Download **Chrono Dawn Mod** (choose the version matching your Minecraft and loader):
   - `chronodawn-0.7.0+1.21.2-fabric.jar` for Fabric (1.21.2)
   - `chronodawn-0.7.0+1.21.2-neoforge.jar` for NeoForge (1.21.2)
   - `chronodawn-0.7.0+1.21.1-fabric.jar` for Fabric (1.21.1)
   - `chronodawn-0.7.0+1.21.1-neoforge.jar` for NeoForge (1.21.1)
...
Chrono Dawn contains **11 unique biomes**:

1. **Chrono Dawn Forest** - Dense with Time Wood trees, moderate difficulty
2. **Chrono Dawn Plains** - Open flatlands with scattered Time Wood trees
3. **Chrono Dawn Desert** - Sandy terrain covered in pale-blue **Temporal Sand** and **Temporal Sandstone**
...
11. **Faded Plains** - A withered wasteland at the edge of the desert, where sun-bleached grass clings to cracked soil and bare snags stand in silence
...
**A**: You'll receive the "Chronicle of Chrono Dawn" guide book automatically when entering the Chrono Dawn dimension. Use this guide to learn about progression, structures, bosses, and items in the frozen world.
