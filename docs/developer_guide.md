...
After building:
- **Fabric JAR**: `fabric/1.21.11/build/libs/chronodawn-0.7.0+1.21.11-fabric.jar`
- **NeoForge JAR**: `neoforge/1.21.11/build/libs/chronodawn-0.7.0+1.21.11-neoforge.jar`
- **Common JAR**: `common/1.21.11/build/libs/common-1.21.11-0.7.0.jar` (bundled into loader JARs)
