...
- **11 Unique Biomes**: Forest, Plains, Desert, Mountain, Ocean, Snowy, Swamp, Dark Forest, Ancient Forest, Prairies, and **Faded Plains** — a withered wasteland with sun-faded grass and bare snags
...
This mod is built with **Architectury** and supports **Fabric and NeoForge** (plus **Forge** for legacy Minecraft 1.20.1)!
...
- **Dependencies**:
  - **Architectury API** 9.2.14+ (for 1.20.1, legacy), 13.0.8+ (for 1.21.1), 14.0.4+ (for 1.21.2/1.21.3), 15.0.1+ (for 1.21.4), 16.1.4+ (for 1.21.5), 17.0.6+ (for 1.21.6), 17.0.8+ (for 1.21.7/1.21.8), 18.0.3+ (for 1.21.9), 18.0.8+ (for 1.21.10), or 19.0.1+ (for 1.21.11)
