...
public class TickingSheepRenderer extends MobRenderer<TickingSheepEntity, TickingSheepRenderState, TickingSheepBodyModel> {
    ...
    @Override
    public TickingSheepRenderState createRenderState() {
        return new TickingSheepRenderState();
    }

    @Override
    public void extractRenderState(TickingSheepEntity entity, TickingSheepRenderState state, float partialTick) {
