...
import com.chronodawn.client.renderer.mobs.TimelineStriderRenderState;
 ...
 */
public class TimelineStriderModel extends EntityModel<TimelineStriderRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Disc (child of body) - floating disc around waist
    ...
    @Override
    public void setupAnim(TimelineStriderRenderState state) {
