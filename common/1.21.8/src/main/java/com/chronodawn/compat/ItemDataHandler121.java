...
public class ItemDataHandler121 implements ItemDataHandler {
    ...
    public String getString(ItemStack stack, String key) {
        ...
        if (customData != null) {
            // In 1.21.5, getString returns Optional<String>, use getStringOr
            return customData.copyTag().getStringOr(key, "");
        }
        return "";
    }
    ...
    public int getInt(ItemStack stack, String key) {
        ...
        CustomData customData = stack.get(DataComponents.CUSTOM_DATA);
        if (customData != null) {
            // In 1.21.5, getInt returns Optional<Integer>, use getIntOr
            return customData.copyTag().getIntOr(key, 0);
        }
        return 0;
    }
