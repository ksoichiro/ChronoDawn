 ...
 */
public class ChronoBovineRenderer extends MobRenderer<ChronoBovineEntity, ChronoBovineRenderState, ChronoBovineModel> {
    ...
    @Override
    public ChronoBovineRenderState createRenderState() {
        return new ChronoBovineRenderState();
    }

    @Override
    public ResourceLocation getTextureLocation(ChronoBovineRenderState state) {
        return TEXTURE;
    }
}
