package com.chronodawn.compat.v1_20_1.client;
...
/**
 * Handles portal-related effects on the client side (Minecraft 1.20.1).
 *
...
public class PortalEffectHandler {
     ...
     * Manages dimension change detection for fade effect.
     */
