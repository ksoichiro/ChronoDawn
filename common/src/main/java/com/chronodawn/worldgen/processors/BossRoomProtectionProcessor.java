...
public class BossRoomProtectionProcessor extends StructureProcessor {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(
        ...
        if (isBossRoomMin || isBossRoomMax) {
            ...
            ChronoDawn.LOGGER.debug("Stored boss room {} marker at {} for later registration",
            ...
            ChronoDawn.LOGGER.debug("Stored permanent protection {} marker at {} for later registration",
    ...
    public static void registerPendingProtections(ServerLevel level) {
        ...
        for (MarkerData minMarker : bossRoomMinMarkers) {
            ...
            if (closestMax != null) {
                ...
                ChronoDawn.LOGGER.warn("Found boss room min marker at {} but no matching max marker within 100 blocks",
                    minMarker.pos);
            }
        }
        ...
        for (MarkerData minMarker : permanentMinMarkers) {
            ...
            if (closestMax != null) {
                ...
                ChronoDawn.LOGGER.warn("Found permanent protection min marker at {} but no matching max marker within 100 blocks",
                    minMarker.pos);
            }
        }
