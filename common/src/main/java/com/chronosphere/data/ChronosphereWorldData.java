...
/**
 * Base class for world saved data in Chronosphere mod.
 *
 ...
 */
public abstract class ChronosphereWorldData extends SavedData {
    /**
    ...
    protected void debug(String message) {
        Chronosphere.LOGGER.debug("[WorldData] {}", message);
    }
}
