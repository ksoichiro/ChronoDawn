...
/**
 * Saved data for Time Keeper Village placement state in Chronosphere dimension.
 *
 * Tracks:
...
public class TimeKeeperVillageData extends SavedData {
    private static final String DATA_NAME = "chronosphere_time_keeper_village";
    ...
    /**
     * Get or create the Time Keeper Village data for a Chronosphere level.
     *
     * @param level ServerLevel (should be Chronosphere dimension)
    ...
    public static TimeKeeperVillageData load(CompoundTag tag, HolderLookup.Provider provider) {
        ...
        Chronosphere.LOGGER.info("Loaded TimeKeeperVillageData: placed={}, position={}",
    ...
    public void setPlaced(BlockPos pos) {
        ...
        setDirty();
        Chronosphere.LOGGER.info("Time Keeper Village marked as placed at {}", pos);
    }
}
