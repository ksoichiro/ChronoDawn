 ...
 * - Biome-specific spawning (chronodawn_desert only)
 ...
 */
public class DesertClockTowerTest extends ChronoDawnTestBase {

    private static final String STRUCTURE_NBT_PATH = "common/src/main/resources/data/chronodawn/structures/desert_clock_tower.nbt";
    private static final String STRUCTURE_JSON_PATH = "common/src/main/resources/data/chronodawn/worldgen/structure/desert_clock_tower.json";
    private static final String STRUCTURE_SET_JSON_PATH = "common/src/main/resources/data/chronodawn/worldgen/structure_set/desert_clock_tower.json";
    private static final String LOOT_TABLE_PATH = "common/src/main/resources/data/chronodawn/loot_table/chests/desert_clock_tower.json";
    ...
    public void testStructureJSONContainsBiomeFilter() throws Exception {
        logTest("Testing Desert Clock Tower structure JSON contains biome filter for chronodawn_desert");
        ...
        assertTrue(content.contains("chronodawn:chronodawn_desert"),
                "Structure JSON should specify chronodawn_desert biome");
    }

    @Disabled("Requires Minecraft runtime environment - tested in-game")
    @Test
    public void testDesertClockTowerGeneratesInDesertBiome() {
        logTest("Testing Desert Clock Tower generates only in chronodawn_desert biome");

        // Expected behavior:
        // 1. Load ChronoDawn dimension with desert biome
        // 2. Use /locate structure chronodawn:desert_clock_tower command
