...
public class PortalStabilizationTest extends ChronoDawnTestBase {
    ...
    public void testBidirectionalTravelAfterStabilization() {
        ...
        // Expected behavior:
        // - Player can travel from ChronoDawn to Overworld through stabilized portal
        // - Player can travel from Overworld to ChronoDawn through stabilized portal
