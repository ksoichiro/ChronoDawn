 ...
 * - Teleportation to ChronoDawn dimension
 ...
 *
 * Reference: data-model.md (Portal System, Dimension: ChronoDawn)
...
public class DimensionTravelTest extends ChronoDawnTestBase {

    @Test
    public void testTravelToChronoDawn() {
        logTest("Testing player travel from Overworld to ChronoDawn");

        // Expected behavior:
        // 1. Player enters activated portal in Overworld
        // 2. Player is teleported to ChronoDawn dimension
    ...
    @Test
    public void testSpawnLocationInChronoDawn() {
        logTest("Testing player spawns near Forgotten Library in ChronoDawn");

        // Expected behavior:
        // - Player should spawn at designated location in ChronoDawn
    ...
    public void testTimeDistortionEffectOnArrival() {
        ...
        // Expected behavior:
        // - Custom mobs in ChronoDawn should have Slowness IV effect
