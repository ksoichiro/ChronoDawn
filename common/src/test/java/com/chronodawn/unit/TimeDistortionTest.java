 ...
 * in the ChronoDawn dimension while leaving players unaffected.
 *
 * Effect Properties:
 ...
 */
public class TimeDistortionTest extends ChronoDawnTestBase {
    ...
    @Test
    public void testSlownessEffectAppliedToHostileMobsInChronoDawn() {
        logTest("Testing Slowness IV effect application to hostile mobs in ChronoDawn");

        // Expected behavior:
        // 1. Create a Monster entity in ChronoDawn dimension
    ...
    public void testPlayersNotAffectedByTimeDistortion() {
        ...
        // Expected behavior:
        // 1. Create a Player entity in ChronoDawn dimension
    ...
    @Disabled("Requires Minecraft runtime environment - tested in-game")
    @Test
    public void testNoEffectInNonChronoDawnDimensions() {
        logTest("Testing no effect applied in non-ChronoDawn dimensions");
    ...
    public void testNonHostileMobsNotAffected() {
        ...
        // Expected behavior:
        // 1. Create a passive mob (e.g., Cow, Sheep) in ChronoDawn dimension
