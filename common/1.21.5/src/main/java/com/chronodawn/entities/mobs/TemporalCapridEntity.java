...
public class TemporalCapridEntity extends Animal {
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(ModItemTags.TEMPORAL_CAPRID_FOOD);
    }

    @Nullable
    @Override
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        return com.chronodawn.registry.ModEntities.TEMPORAL_CAPRID.get().create(level, EntitySpawnReason.BREEDING);
    }
