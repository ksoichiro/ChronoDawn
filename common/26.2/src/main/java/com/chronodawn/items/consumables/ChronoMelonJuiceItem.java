...
// 26.2: CriteriaTriggers moved from net.minecraft.advancements to net.minecraft.advancements.triggers
    ...
    public static Properties createProperties() {
        ...
        return new Properties()
                ...
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "chrono_melon_juice")));
    }
