...
public class SecondwingFowlEntity extends Animal {
    ...
    // 26.1.2: CHICKEN_AMBIENT/CHICKEN_HURT/CHICKEN_DEATH were removed in favor of the
    // new ChickenSoundVariant registry system. We always use the "classic" adult
    // variant, matching the old hardcoded vanilla sounds.

    private SoundEvent chickenSound(java.util.function.Function<
        ...
        return selector.apply(
            this.registryAccess().lookupOrThrow(Registries.CHICKEN_SOUND_VARIANT)
                .getValueOrThrow(ChickenSoundVariants.CLASSIC)
                .adultSounds()
        ).value();
    }
    ...
    protected SoundEvent getAmbientSound() {
        return chickenSound(net.minecraft.world.entity.animal.chicken.ChickenSoundVariant.ChickenSoundSet::ambientSound);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return chickenSound(net.minecraft.world.entity.animal.chicken.ChickenSoundVariant.ChickenSoundSet::hurtSound);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return chickenSound(net.minecraft.world.entity.animal.chicken.ChickenSoundVariant.ChickenSoundSet::deathSound);
    }
