...
public abstract class CompatSavedData extends SavedData implements SavedDataHandler {
    ...
    /**
     * Version-compatible wrapper for SavedDataStorage.computeIfAbsent().
     ...
     *
     * @param storage SavedDataStorage instance
    ...
    public static <T extends SavedData> T computeIfAbsent(
        ...
        //
        // 26.1.2: SavedDataType's id is now an Identifier rather than a bare String.
