...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> TEMPORAL_COAL_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_COAL_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_COAL_ORE.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_GOLD_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_GOLD_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_GOLD_ORE.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_IRON_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_IRON_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_IRON_ORE.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_REDSTONE_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_REDSTONE_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_REDSTONE_ORE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> CHRONITE_BLOCK = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.CHRONITE_BLOCK.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONITE_BLOCK.id()))))
    );
    ...
    public static final RegistrySupplier<Item> CLOCKWORK_DIAL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.CLOCKWORK_DIAL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CLOCKWORK_DIAL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_COBBLESTONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_COBBLESTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_COBBLESTONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_STONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_STAIRS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_STONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> SMOOTH_TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.SMOOTH_TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.SMOOTH_TEMPORAL_STONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> SMOOTH_TEMPORAL_STONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.SMOOTH_TEMPORAL_STONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.SMOOTH_TEMPORAL_STONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_STONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_WALL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SAND = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SAND.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SAND.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_GRAVEL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_GRAVEL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_GRAVEL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_STAIRS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_WALL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_COBBLESTONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_COBBLESTONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_COBBLESTONE_STAIRS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_COBBLESTONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_COBBLESTONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_COBBLESTONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE = ITEMS.register(
        ModItemId.MOSSY_TEMPORAL_COBBLESTONE.id(),
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE.id()))))
    );

    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_STAIRS = ITEMS.register(
        ModItemId.MOSSY_TEMPORAL_COBBLESTONE_STAIRS.id(),
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_STAIRS.id()))))
    );

    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_SLAB = ITEMS.register(
        ModItemId.MOSSY_TEMPORAL_COBBLESTONE_SLAB.id(),
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_SLAB.id()))))
    );

    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_WALL.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS_SLAB.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS_WALL.id()))))
    );
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_STONE_BRICKS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_STONE_BRICKS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_STONE_BRICKS.id()))))
    );
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_STONE_BRICKS_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_STONE_BRICKS_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_STONE_BRICKS_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_STONE_BRICKS_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_STONE_BRICKS_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_STONE_BRICKS_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BUTTON = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BUTTON.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BUTTON.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_PRESSURE_PLATE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_PRESSURE_PLATE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_PRESSURE_PLATE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE_WALL.id()))))
    );
    public static final RegistrySupplier<Item> POLISHED_DEEPSLATE_TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.POLISHED_DEEPSLATE_TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.POLISHED_DEEPSLATE_TEMPORAL_STONE.id()))))
    );
    public static final RegistrySupplier<Item> POLISHED_DEEPSLATE_TEMPORAL_STONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.POLISHED_DEEPSLATE_TEMPORAL_STONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.POLISHED_DEEPSLATE_TEMPORAL_STONE_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> POLISHED_DEEPSLATE_TEMPORAL_STONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.POLISHED_DEEPSLATE_TEMPORAL_STONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.POLISHED_DEEPSLATE_TEMPORAL_STONE_SLAB.id()))))
    );
    public static final RegistrySupplier<Item> POLISHED_DEEPSLATE_TEMPORAL_STONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.POLISHED_DEEPSLATE_TEMPORAL_STONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.POLISHED_DEEPSLATE_TEMPORAL_STONE_WALL.id()))))
    );

    // Temporal Pointed Dripstone (cave decoration)
    public static final RegistrySupplier<Item> TEMPORAL_POINTED_DRIPSTONE = ITEMS.register(
        ModItemId.TEMPORAL_POINTED_DRIPSTONE.id(),
        () -> new BlockItem(ModBlocks.TEMPORAL_POINTED_DRIPSTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "temporal_pointed_dripstone"))))
    );
    ...
    public static final RegistrySupplier<Item> PURPLE_TIME_TORCH = ITEMS.register(
        ...
        () -> new TimeTorchItem(ModBlocks.PURPLE_TIME_TORCH.get(), ModBlocks.WALL_PURPLE_TIME_TORCH,
            new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.PURPLE_TIME_TORCH.id()))))
    );
    ...
    public static final RegistrySupplier<Item> ORANGE_TIME_TORCH = ITEMS.register(
        ...
        () -> new TimeTorchItem(ModBlocks.ORANGE_TIME_TORCH.get(), ModBlocks.WALL_ORANGE_TIME_TORCH,
            new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.ORANGE_TIME_TORCH.id()))))
    );
    ...
    public static final RegistrySupplier<Item> PINK_TIME_TORCH = ITEMS.register(
        ...
        () -> new TimeTorchItem(ModBlocks.PINK_TIME_TORCH.get(), ModBlocks.WALL_PINK_TIME_TORCH,
            new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.PINK_TIME_TORCH.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_LANTERN = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_LANTERN.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_LANTERN.id()))))
    );
    ...
    public static final RegistrySupplier<Item> DAWN_LANTERN = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DAWN_LANTERN.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DAWN_LANTERN.id()))))
    );
    ...
    public static final RegistrySupplier<Item> DUSK_LANTERN = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DUSK_LANTERN.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DUSK_LANTERN.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_CHESTPLATE = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(TemporalAmberArmorItem.createProperties(ArmorType.CHESTPLATE)
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_CHESTPLATE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_LEGGINGS = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(TemporalAmberArmorItem.createProperties(ArmorType.LEGGINGS)
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_LEGGINGS.id()))))
    );
     ...
     * in MC 1.21.11) except for {@code block_delay_seconds}, which is sourced from
     ...
     */
    // 26.1.2: BlocksAttacks#bypassedBy is now a HolderSet<DamageType> instead of a
    // TagKey<DamageType>. DamageType is a dynamic (datapack-driven) registry, so it isn't
    // available yet when Items are being registered; we resolve the tag lazily via
    // Item.Properties#delayedComponent(), which supplies a HolderLookup.Provider once
    // registries are actually loaded.
    private static BlocksAttacks chronoShieldBlocksAttacks(ChronoShieldTier tier, HolderLookup.Provider provider) {
        return new BlocksAttacks(
            tier.blockDelaySeconds,
            1.0F,
            List.of(new BlocksAttacks.DamageReduction(90.0F, Optional.empty(), 0.0F, 1.0F)),
            new BlocksAttacks.ItemDamageFunction(3.0F, 1.0F, 1.0F),
            Optional.of(provider.lookupOrThrow(net.minecraft.core.registries.Registries.DAMAGE_TYPE).getOrThrow(DamageTypeTags.BYPASSES_SHIELD)),
    ...
    public static final RegistrySupplier<Item> CLOCKSTONE_SHIELD = ITEMS.register(
        ...
        () -> new com.chronodawn.items.ClockstoneShieldItem(
            new Item.Properties()
                .delayedComponent(DataComponents.BLOCKS_ATTACKS, provider -> chronoShieldBlocksAttacks(ChronoShieldTier.T1, provider))
    ...
    public static final RegistrySupplier<Item> ENHANCED_CLOCKSTONE_SHIELD = ITEMS.register(
        ...
        () -> new com.chronodawn.items.EnhancedClockstoneShieldItem(
            new Item.Properties()
                .delayedComponent(DataComponents.BLOCKS_ATTACKS, provider -> chronoShieldBlocksAttacks(ChronoShieldTier.T2, provider))
                .component(DataComponents.EQUIPPABLE,
                    Equippable.builder(EquipmentSlot.OFFHAND).setSwappable(false).build())
                .setId(ResourceKey.create(Registries.ITEM,
    ...
    public static final RegistrySupplier<Item> ENTROPY_CRYSTAL_SHIELD = ITEMS.register(
        ...
        () -> new com.chronodawn.items.EntropyCrystalShieldItem(
            new Item.Properties()
                .delayedComponent(DataComponents.BLOCKS_ATTACKS, provider -> chronoShieldBlocksAttacks(ChronoShieldTier.T3, provider))
                .component(DataComponents.EQUIPPABLE,
                    Equippable.builder(EquipmentSlot.OFFHAND).setSwappable(false).build())
                .setId(ResourceKey.create(Registries.ITEM,
    ...
    public static final RegistrySupplier<Item> CHRONO_BOVINE_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONO_BOVINE_SPAWN_EGG.id())))
        )
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_CAPRID_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_CAPRID_SPAWN_EGG.id())))
        )
    );

    /**
     * Chrono Ursid Spawn Egg
    ...
    public static final RegistrySupplier<Item> CHRONO_URSID_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONO_URSID_SPAWN_EGG.id())))
        )
    );
    ...
    public static void populateCreativeTab(
        ...
        output.accept(MOSSY_TEMPORAL_COBBLESTONE.get());
        ...
        output.accept(TEMPORAL_POINTED_DRIPSTONE.get());
