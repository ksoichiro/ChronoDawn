...
import com.chronodawn.client.renderer.mobs.SecondhandArcherRenderState;
 ...
 */
public class SecondhandArcherModel extends EntityModel<SecondhandArcherRenderState> implements ArmedModel<SecondhandArcherRenderState> {
    ...
    @Override
    public void setupAnim(SecondhandArcherRenderState state) {
    ...
    @Override
    public void translateToHand(SecondhandArcherRenderState state, HumanoidArm arm, PoseStack poseStack) {
