...
public class MomentCreeperWhiteFlashLayer extends RenderLayer<MomentCreeperRenderState, MomentCreeperModel> {
    private static final Identifier WHITE_TEXTURE = CompatResourceLocation.create(
        "chronodawn",
        "textures/entity/mobs/moment_creeper_white.png"
    );
    private static final RenderType WHITE_FLASH = RenderTypes.entityTranslucent(WHITE_TEXTURE);
