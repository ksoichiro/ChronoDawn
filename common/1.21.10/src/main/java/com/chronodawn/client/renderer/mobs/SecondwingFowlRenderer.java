 ...
 */
public class SecondwingFowlRenderer extends MobRenderer<SecondwingFowlEntity, SecondwingFowlRenderState, SecondwingFowlModel> {
    ...
    @Override
    public SecondwingFowlRenderState createRenderState() {
        return new SecondwingFowlRenderState();
    }

    @Override
    public ResourceLocation getTextureLocation(SecondwingFowlRenderState state) {
        return TEXTURE;
    }
}
