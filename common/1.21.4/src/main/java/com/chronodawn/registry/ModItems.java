...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_AMBER_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_ORE.id()))))
    );
    public static final RegistrySupplier<Item> DEEPSLATE_TEMPORAL_AMBER_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_TEMPORAL_AMBER_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_TEMPORAL_AMBER_ORE.id()))))
    );
    public static final RegistrySupplier<Item> DEEPSLATE_TEMPORAL_GOLD_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_TEMPORAL_GOLD_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_TEMPORAL_GOLD_ORE.id()))))
    );
    public static final RegistrySupplier<Item> DEEPSLATE_TEMPORAL_REDSTONE_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_TEMPORAL_REDSTONE_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_TEMPORAL_REDSTONE_ORE.id()))))
    );
    public static final RegistrySupplier<Item> DEEPSLATE_CLOCKSTONE_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_CLOCKSTONE_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_CLOCKSTONE_ORE.id()))))
    );
    public static final RegistrySupplier<Item> CHRONITE_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.CHRONITE_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONITE_ORE.id()))))
    );
    public static final RegistrySupplier<Item> DEEPSLATE_CHRONITE_ORE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_CHRONITE_ORE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_CHRONITE_ORE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> CHRONITE_BLOCK = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.CHRONITE_BLOCK.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONITE_BLOCK.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_GRAVEL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_GRAVEL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_GRAVEL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_STAIRS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SANDSTONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SANDSTONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SANDSTONE_WALL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_STAIRS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> MOSSY_TEMPORAL_COBBLESTONE_WALL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.MOSSY_TEMPORAL_COBBLESTONE_WALL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.MOSSY_TEMPORAL_COBBLESTONE_WALL.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_STONE_BRICKS_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_STONE_BRICKS_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_STONE_BRICKS_SLAB.id()))))
    );
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DEEPSLATE_TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DEEPSLATE_TEMPORAL_STONE.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS.id()))))
    );
    public static final RegistrySupplier<Item> COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB.id()))))
    );
    ...
    // Temporal Pointed Dripstone - Unified stalactite/stalagmite item (cave decoration)
    public static final RegistrySupplier<Item> TEMPORAL_POINTED_DRIPSTONE = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_POINTED_DRIPSTONE.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_POINTED_DRIPSTONE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> ENTROPY_CRYSTAL = ITEMS.register(
        ...
        () -> new Item(new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.ENTROPY_CRYSTAL.id()))))
    );
    public static final RegistrySupplier<Item> RAW_TEMPORAL_AMBER = ITEMS.register(
        ModItemId.RAW_TEMPORAL_AMBER.id(),
        () -> new Item(new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.RAW_TEMPORAL_AMBER.id()))))
    );
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_DUST = ITEMS.register(
        ModItemId.TEMPORAL_AMBER_DUST.id(),
        () -> new Item(new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_DUST.id()))))
    );
    ...
    public static final RegistrySupplier<Item> FADED_TEMPORAL_GRASS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.FADED_TEMPORAL_GRASS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.FADED_TEMPORAL_GRASS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_DEAD_BUSH = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_DEAD_BUSH.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_DEAD_BUSH.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_KELP = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_KELP.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_KELP.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_SEAGRASS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TEMPORAL_SEAGRASS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_SEAGRASS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TALL_TEMPORAL_SEAGRASS = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TALL_TEMPORAL_SEAGRASS.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TALL_TEMPORAL_SEAGRASS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> LUMEN_POLYP = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.LUMEN_POLYP.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.LUMEN_POLYP.id()))))
    );
    ...
    public static final RegistrySupplier<Item> DAWN_CHRONO_CORAL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DAWN_CHRONO_CORAL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DAWN_CHRONO_CORAL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> DUSK_CHRONO_CORAL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.DUSK_CHRONO_CORAL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DUSK_CHRONO_CORAL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TWILIGHT_CHRONO_CORAL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.TWILIGHT_CHRONO_CORAL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TWILIGHT_CHRONO_CORAL.id()))))
    );
    ...
    public static final RegistrySupplier<Item> ETERNAL_CHRONO_CORAL = ITEMS.register(
        ...
        () -> new BlockItem(ModBlocks.ETERNAL_CHRONO_CORAL.get(), new Item.Properties()
                .useBlockDescriptionPrefix()
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.ETERNAL_CHRONO_CORAL.id()))))
    );
        ...
        () -> new Item(new Item.Properties()
                ...
                .component(DataComponents.CONSUMABLE,
                    Consumable.builder()
                        ...
                        .build())
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.DRIED_TEMPORAL_KELP.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_HELMET = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(ArmorType.HELMET, TemporalAmberArmorItem.createProperties(ArmorType.HELMET)
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_HELMET.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_CHESTPLATE = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(ArmorType.CHESTPLATE, TemporalAmberArmorItem.createProperties(ArmorType.CHESTPLATE)
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_CHESTPLATE.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_LEGGINGS = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(ArmorType.LEGGINGS, TemporalAmberArmorItem.createProperties(ArmorType.LEGGINGS)
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_AMBER_LEGGINGS.id()))))
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_AMBER_BOOTS = ITEMS.register(
        ...
        () -> new TemporalAmberArmorItem(ArmorType.BOOTS, TemporalAmberArmorItem.createProperties(ArmorType.BOOTS)
                .setId(ResourceKey.create(Registries.ITEM,
    ...
    public static final RegistrySupplier<Item> CHRONO_BOVINE_MEAT = ITEMS.register(
        ...
        () -> new Item(new Item.Properties()
                .food(new net.minecraft.world.food.FoodProperties.Builder()
                    ...
                    .build())
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONO_BOVINE_MEAT.id()))))
    );
    ...
    public static final RegistrySupplier<Item> COOKED_CHRONO_BOVINE_MEAT = ITEMS.register(
        ...
        () -> new Item(new Item.Properties()
                .food(new net.minecraft.world.food.FoodProperties.Builder()
                    ...
                    .build())
                .setId(ResourceKey.create(Registries.ITEM,
                    ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.COOKED_CHRONO_BOVINE_MEAT.id()))))
    );
    ...
    public static final RegistrySupplier<Item> CHRONO_BOVINE_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONO_BOVINE_SPAWN_EGG.id())))
        )
    );
    ...
    public static final RegistrySupplier<Item> TEMPORAL_CAPRID_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.TEMPORAL_CAPRID_SPAWN_EGG.id())))
        )
    );
    ...
    public static final RegistrySupplier<Item> CHRONO_URSID_SPAWN_EGG = ITEMS.register(
        ...
        () -> new com.chronodawn.items.DeferredSpawnEggItem(
            ...
            new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM,
                        ResourceLocation.fromNamespaceAndPath(ChronoDawn.MOD_ID, ModItemId.CHRONO_URSID_SPAWN_EGG.id())))
        )
    );
