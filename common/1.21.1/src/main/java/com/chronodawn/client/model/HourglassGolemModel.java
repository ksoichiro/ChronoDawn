 ...
 */
public class HourglassGolemModel extends EntityModel<HourglassGolemEntity> {
    ...
    @Override
    public void setupAnim(HourglassGolemEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        // Arm swing
