 ...
 */
public class TemporalCapridModel extends EntityModel<TemporalCapridEntity> {
    ...
    @Override
    public void setupAnim(TemporalCapridEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float walkSpeed = limbSwingAmount;
        float walkPos = limbSwing;
