...
public class UnstableFungus extends Block {
    ...
    public static BlockBehaviour.Properties createProperties() {
        return BlockBehaviour.Properties.of()
                ...
                .noCollision() // Entities can walk through it
                .setId(ResourceKey.create(Registries.BLOCK,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "unstable_fungus")));
    }
    ...
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity, InsideBlockEffectApplier effectApplier, boolean colliding) {
        super.entityInside(state, level, pos, entity, effectApplier, colliding);
