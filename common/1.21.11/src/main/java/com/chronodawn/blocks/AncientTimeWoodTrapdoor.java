...
/**
 * Ancient Time Wood Trapdoor block.
 *
 ...
 *
 * Crafting:
 * - 6x Ancient Time Wood Planks (2 rows of 3) → 2x Ancient Time Wood Trapdoor
 */
public class AncientTimeWoodTrapdoor extends TrapDoorBlock {
    public AncientTimeWoodTrapdoor(BlockBehaviour.Properties properties) {
        super(BlockSetType.OAK, properties);
    }

    /**
     * Create default properties for Ancient Time Wood Trapdoor.
     *
    ...
    public static BlockBehaviour.Properties createProperties() {
        return BlockBehaviour.Properties.of()
                ...
                .setId(ResourceKey.create(Registries.BLOCK,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "ancient_time_wood_trapdoor")));
    }
}
