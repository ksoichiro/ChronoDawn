 ...
 *
 * This class provides a centralized registry for all custom sound events in the ChronoDawn mod.
 * Using Architectury's DeferredRegister ensures cross-loader compatibility between NeoForge and Fabric.
 */
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ChronoDawn.MOD_ID, Registries.SOUND_EVENT);
    ...
    /**
     * Shield Echo Generate Sound
     * Played when a Time Echo charge is generated by the Temporal Guardian Shield.
     * Placeholder OGG: 880 Hz sine, 0.3s.
     */
    public static final RegistrySupplier<SoundEvent> SHIELD_ECHO_GENERATE = registerSound("shield_echo_generate");

    /**
     * Shield Echo Active Pulse Sound
     * Played each pulse while a Time Echo charge is active on the shield.
     * Placeholder OGG: 660 Hz sine, 0.2s.
     */
    public static final RegistrySupplier<SoundEvent> SHIELD_ECHO_ACTIVE_PULSE = registerSound("shield_echo_active_pulse");

    /**
     * Shield Echo Consume Sound
     * Played when a Time Echo charge is consumed to mitigate incoming damage.
     * Placeholder OGG: 1100 Hz sine, 0.4s.
     */
    public static final RegistrySupplier<SoundEvent> SHIELD_ECHO_CONSUME = registerSound("shield_echo_consume");
    ...
    private static RegistrySupplier<SoundEvent> registerSound(String name) {
        Identifier id = CompatResourceLocation.create(ChronoDawn.MOD_ID, name);
