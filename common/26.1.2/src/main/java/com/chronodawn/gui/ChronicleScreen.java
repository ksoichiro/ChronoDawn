...
public class ChronicleScreen extends Screen {
    ...
    private static final Identifier CORNER_TOP_LEFT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/corner_top_left.png");
    private static final Identifier CORNER_TOP_RIGHT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/corner_top_right.png");
    private static final Identifier CORNER_BOTTOM_LEFT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/corner_bottom_left.png");
    private static final Identifier CORNER_BOTTOM_RIGHT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/corner_bottom_right.png");
    // Edges (4 parts - tileable 16x16)
    private static final Identifier EDGE_TOP =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/edge_top.png");
    private static final Identifier EDGE_BOTTOM =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/edge_bottom.png");
    private static final Identifier EDGE_LEFT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/edge_left.png");
    private static final Identifier EDGE_RIGHT =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/edge_right.png");
    // Page background (1 part - tileable 16x16)
    private static final Identifier PAGE_BACKGROUND =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/page.png");
    // Binding shadow (3 parts - top/middle/bottom for seamless corners)
    private static final Identifier BINDING_TOP =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/binding_top.png");
    private static final Identifier BINDING_MIDDLE =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/binding_middle.png");
    private static final Identifier BINDING_BOTTOM =
        Identifier.fromNamespaceAndPath("chronodawn", "textures/gui/chronicle/binding_bottom.png");
    ...
    // 26.1.2: Screen#renderBackground renamed to extractBackground
    @Override
    ...
    // 26.1.2: Screen#render/Renderable#render renamed to extractRenderState
    @Override
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        // Layer 1: Render dark background (via our overridden extractBackground)
        ...
        // 26.1.2: GuiGraphicsExtractor#renderTooltip renamed to tooltip()
