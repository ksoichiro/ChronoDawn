...
import com.chronodawn.client.renderer.mobs.ChronoTurtleRenderState;
 ...
 * Texture size: 128x64
 */
public class ChronoTurtleModel extends EntityModel<ChronoTurtleRenderState> {
    ...
    @Override
    public void setupAnim(ChronoTurtleRenderState state) {
