...
import com.chronodawn.blocks.TemporalStoneBricksBlock;
...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "time_wood")))
        )
    );
    ...
    public static final RegistrySupplier<Block> STRIPPED_TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .sound(SoundType.WOOD)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "stripped_time_wood")))
        )
    );
    ...
    public static final RegistrySupplier<Block> CLOCK_TOWER_TELEPORTER = BLOCKS.register(
        ...
        () -> new ClockTowerTeleporterBlock(
            CompatBlockProperties.ofFullCopy(Blocks.GLOWSTONE)
                ...
                .noOcclusion()
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "clock_tower_teleporter")))
        )
    );
    ...
    public static final RegistrySupplier<Block> COBBLED_DEEPSLATE_TEMPORAL_STONE = BLOCKS.register(
        ModBlockId.COBBLED_DEEPSLATE_TEMPORAL_STONE.id(),
        () -> new CobbledDeepslateTemporalStoneBlock(CobbledDeepslateTemporalStoneBlock.createProperties())
    );
    public static final RegistrySupplier<Block> COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS = BLOCKS.register(
        ModBlockId.COBBLED_DEEPSLATE_TEMPORAL_STONE_STAIRS.id(),
        () -> new CobbledDeepslateTemporalStoneStairs(CobbledDeepslateTemporalStoneStairs.createProperties())
    );
    public static final RegistrySupplier<Block> COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB = BLOCKS.register(
        ModBlockId.COBBLED_DEEPSLATE_TEMPORAL_STONE_SLAB.id(),
        () -> new CobbledDeepslateTemporalStoneSlab(CobbledDeepslateTemporalStoneSlab.createProperties())
    );
    ...
    public static final RegistrySupplier<Block> TEMPORAL_POINTED_DRIPSTONE = BLOCKS.register(
        ModBlockId.TEMPORAL_POINTED_DRIPSTONE.id(),
        () -> new TemporalPointedDripstoneBlock(TemporalPointedDripstoneBlock.createProperties())
    );
    ...
    public static final RegistrySupplier<Block> TEMPORAL_STONE_BRICKS = BLOCKS.register(
        ModBlockId.TEMPORAL_STONE_BRICKS.id(),
        () -> new TemporalStoneBricksBlock(TemporalStoneBricksBlock.createProperties())
    );
    public static final RegistrySupplier<Block> TEMPORAL_STONE_BRICKS_STAIRS = BLOCKS.register(
        ModBlockId.TEMPORAL_STONE_BRICKS_STAIRS.id(),
        () -> new TemporalStoneBricksStairs(TemporalStoneBricksStairs.createProperties())
    );
    public static final RegistrySupplier<Block> TEMPORAL_STONE_BRICKS_SLAB = BLOCKS.register(
        ModBlockId.TEMPORAL_STONE_BRICKS_SLAB.id(),
        () -> new TemporalStoneBricksSlab(TemporalStoneBricksSlab.createProperties())
    );
    ...
    public static final RegistrySupplier<Block> TIME_WHEAT = BLOCKS.register(
        ...
        () -> new TimeWheatBlock(
            Block.Properties.of()
                ...
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "time_wheat")))
        )
    );
    ...
    public static final RegistrySupplier<Block> TIME_WHEAT_BALE = BLOCKS.register(
        ...
        () -> new TimeWheatBaleBlock(
            CompatBlockProperties.ofFullCopy(Blocks.HAY_BLOCK)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "time_wheat_bale")))
        )
    );
    ...
    public static final RegistrySupplier<Block> TEMPORAL_ROOT = BLOCKS.register(
        ...
        () -> new TemporalRootBlock(
            CompatBlockProperties.ofFullCopy(Blocks.CARROTS)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "temporal_root")))
        )
    );
    ...
    public static final RegistrySupplier<Block> CHRONO_MELON = BLOCKS.register(
        ...
        () -> new ChronoMelonBlock(
            CompatBlockProperties.ofFullCopy(Blocks.MELON)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "chrono_melon")))
        )
    );
    ...
    public static final RegistrySupplier<Block> CHRONO_MELON_STEM = BLOCKS.register(
        ...
        () -> new ChronoMelonStemBlock(
            CompatBlockProperties.ofFullCopy(Blocks.MELON_STEM)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "chrono_melon_stem")))
        )
    );
    ...
    public static final RegistrySupplier<Block> ATTACHED_CHRONO_MELON_STEM = BLOCKS.register(
        ...
        () -> new AttachedChronoMelonStemBlock(
            CompatBlockProperties.ofFullCopy(Blocks.ATTACHED_MELON_STEM)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "attached_chrono_melon_stem")))
        )
    );
    ...
    public static final RegistrySupplier<Block> TIMELESS_MUSHROOM = BLOCKS.register(
        ...
        () -> new TimelessMushroomBlock(
            CompatBlockProperties.ofFullCopy(Blocks.BROWN_MUSHROOM)
                .lightLevel(state -> 6)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "timeless_mushroom")))
        )
    );
    ...
    public static final RegistrySupplier<Block> TEMPORAL_GRASS = BLOCKS.register(
        ModBlockId.TEMPORAL_GRASS.id(),
        () -> new TemporalShortGrassBlock(TemporalShortGrassBlock.createProperties("temporal_grass"))
    );
    ...
    public static final RegistrySupplier<Block> TEMPORAL_DEAD_BUSH = BLOCKS.register(
        ...
        () -> new TemporalDeadBushBlock(TemporalDeadBushBlock.createProperties("temporal_dead_bush"))
    );
    ...
    public static final RegistrySupplier<Block> DAWN_CHRONO_CORAL = BLOCKS.register(
        ...
        () -> new ChronoCoralBlock(ChronoCoralBlock.createProperties(ModBlockId.DAWN_CHRONO_CORAL.id()))
    );

    public static final RegistrySupplier<Block> DUSK_CHRONO_CORAL = BLOCKS.register(
        ModBlockId.DUSK_CHRONO_CORAL.id(),
        () -> new ChronoCoralBlock(ChronoCoralBlock.createProperties(ModBlockId.DUSK_CHRONO_CORAL.id()))
    );

    public static final RegistrySupplier<Block> TWILIGHT_CHRONO_CORAL = BLOCKS.register(
        ModBlockId.TWILIGHT_CHRONO_CORAL.id(),
        () -> new ChronoCoralBlock(ChronoCoralBlock.createProperties(ModBlockId.TWILIGHT_CHRONO_CORAL.id()))
    );

    public static final RegistrySupplier<Block> ETERNAL_CHRONO_CORAL = BLOCKS.register(
        ModBlockId.ETERNAL_CHRONO_CORAL.id(),
        () -> new ChronoCoralBlock(ChronoCoralBlock.createProperties(ModBlockId.ETERNAL_CHRONO_CORAL.id()))
    );
    ...
    public static final RegistrySupplier<Block> BOSS_ROOM_DOOR = BLOCKS.register(
        ...
        () -> new BossRoomDoorBlock(
            CompatBlockProperties.ofFullCopy(Blocks.IRON_DOOR)
                .noOcclusion()
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "boss_room_door")))
        )
    );
    ...
    public static final RegistrySupplier<Block> ENTROPY_CRYPT_TRAPDOOR = BLOCKS.register(
        ...
        () -> new EntropyCryptTrapdoorBlock(
            CompatBlockProperties.ofFullCopy(Blocks.IRON_TRAPDOOR)
                .noOcclusion()
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "entropy_crypt_trapdoor")))
        )
    );
    ...
    public static final RegistrySupplier<Block> DECORATIVE_WATER = BLOCKS.register(
        ...
        () -> new DecorativeWaterBlock(ModFluids.DECORATIVE_WATER.get(), CompatBlockProperties.ofFullCopy(Blocks.WATER)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "decorative_water"))))
    );
    ...
    public static final RegistrySupplier<Block> BOSS_ROOM_BOUNDARY_MARKER = BLOCKS.register(
        ...
        () -> new BossRoomBoundaryMarkerBlock(Block.Properties.of()
            ...
            .noOcclusion()
            .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "boss_room_boundary_marker"))))
    );
    ...
    public static final RegistrySupplier<Block> DARK_TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .sound(SoundType.WOOD)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "dark_time_wood")))
        )
    );
    ...
    public static final RegistrySupplier<Block> STRIPPED_DARK_TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .sound(SoundType.WOOD)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "stripped_dark_time_wood")))
        )
    );
    ...
    public static final RegistrySupplier<Block> ANCIENT_TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .sound(SoundType.WOOD)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "ancient_time_wood")))
        )
    );
    ...
    public static final RegistrySupplier<Block> STRIPPED_ANCIENT_TIME_WOOD = BLOCKS.register(
        ...
        () -> new RotatedPillarBlock(
            Block.Properties.of()
                ...
                .sound(SoundType.WOOD)
                .setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BLOCK,
                    net.minecraft.resources.Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "stripped_ancient_time_wood")))
        )
    );
