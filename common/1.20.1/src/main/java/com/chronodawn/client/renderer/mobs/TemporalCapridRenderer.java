 ...
 */
public class TemporalCapridRenderer extends MobRenderer<TemporalCapridEntity, TemporalCapridModel> {
    ...
    @Override
    public ResourceLocation getTextureLocation(TemporalCapridEntity entity) {
        return TEXTURE;
    }
}
