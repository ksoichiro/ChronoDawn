...
public class EntryPageWidget extends AbstractWidget {
    // Vanilla book.png texture for page navigation buttons (1.20.1 uses direct texture offsets)
    ...
    private void renderRecipeVirtualPage(GuiGraphics graphics, VirtualPage virtualPage) {
        ...
        var recipeObj = recipe.get();
        ItemStack result = recipeObj.getResultItem(Minecraft.getInstance().level.registryAccess());
