...
public enum ModItemId {
    ...
    TEMPORAL_STONE_BRICKS("temporal_stone_bricks"),
    TEMPORAL_STONE_BRICKS_STAIRS("temporal_stone_bricks_stairs"),
    TEMPORAL_STONE_BRICKS_SLAB("temporal_stone_bricks_slab"),
    TEMPORAL_STONE_BRICKS_WALL("temporal_stone_bricks_wall"),
    MOSSY_TEMPORAL_STONE_BRICKS("mossy_temporal_stone_bricks"),
    MOSSY_TEMPORAL_STONE_BRICKS_STAIRS("mossy_temporal_stone_bricks_stairs"),
    ...
    CHRONO_BOVINE_SPAWN_EGG("chrono_bovine_spawn_egg"),
    TEMPORAL_CAPRID_SPAWN_EGG("temporal_caprid_spawn_egg"),
    CHRONO_URSID_SPAWN_EGG("chrono_ursid_spawn_egg"),
    ;
