...
public class ChronoDawnGameTestsNeoForge {
    ...
    private static final Identifier EMPTY_STRUCTURE =
        Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "empty_test");
    ...
    public static void onRegisterGameTests(RegisterGameTestsEvent event) {
        ...
        // 26.1.2: TestEnvironmentDefinition gained a SavedDataType type parameter; the
        // registry API deals in the wildcarded Holder<TestEnvironmentDefinition<?>>.
        Holder<TestEnvironmentDefinition<?>> defaultEnv =
            event.registerEnvironment(
                Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "default")
            );
