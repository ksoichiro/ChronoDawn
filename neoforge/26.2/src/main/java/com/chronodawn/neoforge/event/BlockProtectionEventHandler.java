 ...
 *
 * Features:
 * - Listens to BreakBlockEvent (block breaking)
 ...
 *
 * 26.1.2: BlockEvent.BreakEvent was removed and replaced by the top-level
 * BreakBlockEvent class; Player#displayClientMessage(Component, boolean)
 * was removed, action-bar case is now sendOverlayMessage(Component).
 */
