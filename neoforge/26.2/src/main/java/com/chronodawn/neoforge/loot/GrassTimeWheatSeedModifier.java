package com.chronodawn.neoforge.loot;
 ...
 * when grass or ferns are broken in the ChronoDawn dimension.
 *
 * This modifier:
 * 1. Checks if the loot was generated in the ChronoDawn dimension
...
public class GrassTimeWheatSeedModifier extends LootModifier {
    ...
    private static final ResourceKey<Level> CHRONO_DAWN_DIMENSION =
        ResourceKey.create(Registries.DIMENSION,
            Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "chronodawn"));

    /**
     * Constructor for the loot modifier.
     *
     * @param conditions The conditions that must be met for this modifier to apply
     * @param priority The priority of this modifier (26.1.2: LootModifier ctor gained a required int priority param)
     */
    public GrassTimeWheatSeedModifier(LootItemCondition[] conditions, int priority) {
        super(conditions, priority);
    }

    /**
     * Apply the loot modification.
     * Replaces Wheat Seeds with Time Wheat Seeds in ChronoDawn dimension.
     *
