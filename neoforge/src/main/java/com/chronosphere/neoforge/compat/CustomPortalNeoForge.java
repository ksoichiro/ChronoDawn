package com.chronosphere.neoforge.compat;
 ...
 * the Chronosphere portal functionality on NeoForge.
 *
...
public class CustomPortalNeoForge {
     ...
     * to register the Chronosphere portal with Custom Portal API Reforged.
     */
    public static void init() {
        Chronosphere.LOGGER.info("Initializing Custom Portal API Reforged integration (NeoForge)");
        ...
        Chronosphere.LOGGER.info("Chronosphere portal registered with Custom Portal API Reforged");
