...
import com.chronosphere.neoforge.loot.GrassTimeWheatSeedModifier;
...
public class ModLootModifiers {
    public static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> LOOT_MODIFIERS =
        DeferredRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, Chronosphere.MOD_ID);
    ...
    public static void register(IEventBus modEventBus) {
        ...
        Chronosphere.LOGGER.info("Registered ModLootModifiers for NeoForge");
    }
}
