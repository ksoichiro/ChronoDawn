package com.chronosphere.neoforge.client.particle;
...
/**
 * Custom portal particle for Chronosphere dimension.
 *
 * Implements the "sucking in" movement behavior like vanilla Nether portal,
 * with Chronosphere's orange color theme (#db8813).
 *
 ...
 */
public class ChronospherePortalParticle extends TextureSheetParticle {

    /**
     * Chronosphere portal color - Orange (#db8813).
    ...
    protected ChronospherePortalParticle(ClientLevel level, double x, double y, double z,
        ...
        // Apply Chronosphere orange color
        this.rCol = COLOR_R;
        this.gCol = COLOR_G;
        this.bCol = COLOR_B;
    ...
    /**
     * Factory for creating ChronospherePortalParticle instances.
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
                                        ...
                                        double xSpeed, double ySpeed, double zSpeed) {
            ChronospherePortalParticle particle = new ChronospherePortalParticle(
