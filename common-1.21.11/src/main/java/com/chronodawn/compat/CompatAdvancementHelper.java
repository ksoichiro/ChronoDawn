...
public class CompatAdvancementHelper {
     ...
     */
    public static boolean grantAdvancement(MinecraftServer server, ServerPlayer player, Identifier advancementId) {
     ...
     */
    public static boolean advancementExists(MinecraftServer server, Identifier advancementId) {
     ...
     */
    public static boolean hasAdvancement(MinecraftServer server, ServerPlayer player, Identifier advancementId) {
        AdvancementHolder advancementHolder = server.getAdvancements().get(advancementId);
        if (advancementHolder == null) {
            return false;
        }
