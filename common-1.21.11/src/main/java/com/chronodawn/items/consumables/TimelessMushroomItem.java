 ...
 * - Extends BlockItem but uses item.* description prefix for consistency with plantable items
    ...
    public static Properties createProperties() {
        ...
        return new Properties()
                ...
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "timeless_mushroom")));
    }
}
