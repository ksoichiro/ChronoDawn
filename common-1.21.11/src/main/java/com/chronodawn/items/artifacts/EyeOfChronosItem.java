 ...
 *
 * Effect:
 * - Enhanced Time Distortion: When in inventory, all hostile mobs in ChronoDawn receive
 ...
 * slowing all hostile creatures to a near standstill in the ChronoDawn dimension.
 *
 * Implementation:
        ...
        return new Properties()
            ...
            .rarity(net.minecraft.world.item.Rarity.EPIC)
                .setId(ResourceKey.create(Registries.ITEM,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "eye_of_chronos")));
    }
}
