...
public class SecondhandArcherEntity extends Monster implements RangedAttackMob {
    ...
    // 1.21.11: Sun burn logic moved to Mob.burnUndead() using burn_in_daylight entity tag.
    // Our entity is added to the tag via data/chronodawn/tags/entity_type/burn_in_daylight.json.
