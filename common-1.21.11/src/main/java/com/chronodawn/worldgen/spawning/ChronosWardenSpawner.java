...
public class ChronosWardenSpawner {
    ...
    public static void register() {
        LifecycleEvent.SERVER_LEVEL_LOAD.register(level -> {
            if (level instanceof ServerLevel serverLevel) {
                ChronoDawn.LOGGER.debug("Chronos Warden Spawner initialized for dimension: {}", serverLevel.dimension().identifier());
            }
        });
    ...
    public static void reset(ServerLevel level) {
        ...
        ChronoDawn.LOGGER.debug("Chronos Warden Spawner reset for dimension: {}", level.dimension().identifier());
    }
}
