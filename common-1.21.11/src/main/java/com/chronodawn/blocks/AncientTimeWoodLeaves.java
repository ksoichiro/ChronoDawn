...
public class AncientTimeWoodLeaves extends LeavesBlock {
    ...
    public static final MapCodec<AncientTimeWoodLeaves> CODEC = simpleCodec(AncientTimeWoodLeaves::new);
    ...
    public static BlockBehaviour.Properties createProperties() {
        return BlockBehaviour.Properties.of()
                ...
                .setId(ResourceKey.create(Registries.BLOCK,
                    Identifier.fromNamespaceAndPath(ChronoDawn.MOD_ID, "ancient_time_wood_leaves")));
    }
}
