package com.chronodawn.forge.loot;
 ...
 *
 * Implementation: Forge-specific solution for grass/fern loot modification
 */
public class GrassTimeWheatSeedModifier extends LootModifier {
    public static final Codec<GrassTimeWheatSeedModifier> CODEC = RecordCodecBuilder.create(inst ->
