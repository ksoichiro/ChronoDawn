package com.chronodawn.compat.v1_20_1.anvil;
...
public class AnvilRepairHandler {
    ...
    public static int calculateRepairCost(ItemStack leftInput, ItemStack result) {
        ...
        // Add prior work penalty (NBT-based for 1.20.1)
        int leftWorkCost = 0;
        if (leftInput.hasTag() && leftInput.getTag().contains("RepairCost")) {
            leftWorkCost = leftInput.getTag().getInt("RepairCost");
        }
