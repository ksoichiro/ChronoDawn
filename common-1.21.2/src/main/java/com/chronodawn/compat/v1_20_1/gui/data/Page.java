package com.chronodawn.compat.v1_20_1.gui.data;
...
public class Page {
    ...
    public Page(JsonObject json) {
        ...
        if (json.has("text")) {
            ...
            this.recipe = CompatResourceLocation.parse(json.get("recipe").getAsString());
            this.image = null;
            ...
            this.recipe = null;
            // 1.20.1: Use CompatResourceLocation.parse() instead of ResourceLocation.parse()
            this.image = CompatResourceLocation.parse(json.get("image").getAsString());
        } else {
