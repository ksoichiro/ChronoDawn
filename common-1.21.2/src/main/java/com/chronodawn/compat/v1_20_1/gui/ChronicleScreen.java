package com.chronodawn.compat.v1_20_1.gui;
...
public class ChronicleScreen extends Screen {
    ...
    private static final ResourceLocation CORNER_TOP_LEFT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/corner_top_left.png");
    private static final ResourceLocation CORNER_TOP_RIGHT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/corner_top_right.png");
    private static final ResourceLocation CORNER_BOTTOM_LEFT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/corner_bottom_left.png");
    private static final ResourceLocation CORNER_BOTTOM_RIGHT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/corner_bottom_right.png");
    // Edges (4 parts - tileable 16x16)
    private static final ResourceLocation EDGE_TOP =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/edge_top.png");
    private static final ResourceLocation EDGE_BOTTOM =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/edge_bottom.png");
    private static final ResourceLocation EDGE_LEFT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/edge_left.png");
    private static final ResourceLocation EDGE_RIGHT =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/edge_right.png");
    // Page background (1 part - tileable 16x16)
    private static final ResourceLocation PAGE_BACKGROUND =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/page.png");
    // Binding shadow (3 parts - top/middle/bottom for seamless corners)
    private static final ResourceLocation BINDING_TOP =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/binding_top.png");
    private static final ResourceLocation BINDING_MIDDLE =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/binding_middle.png");
    private static final ResourceLocation BINDING_BOTTOM =
        CompatResourceLocation.create("chronodawn", "textures/gui/chronicle/binding_bottom.png");
