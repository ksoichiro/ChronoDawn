...
public final class RegistryDrivenTestData {
     ...
     * These entities should return true for requiresCustomPersistence()
     * and false for removeWhenFarAway().
     */
    @SuppressWarnings("unchecked")
     ...
     * These entities should have FlyingMoveControl and not take fall damage.
     */
    @SuppressWarnings("unchecked")
