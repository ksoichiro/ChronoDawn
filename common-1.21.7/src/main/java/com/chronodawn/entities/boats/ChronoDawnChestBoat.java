...
public class ChronoDawnChestBoat extends ChestBoat {
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        ...
        output.putString("ChronoDawnType", getChronoDawnBoatType().getName());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput input) {
        super.readAdditionalSaveData(input);
        setChronoDawnBoatType(ChronoDawnBoatType.byName(input.getStringOr("ChronoDawnType", ChronoDawnBoatType.TIME_WOOD.getName())));
    }
