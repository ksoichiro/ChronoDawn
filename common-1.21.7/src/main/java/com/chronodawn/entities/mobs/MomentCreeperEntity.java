...
public class MomentCreeperEntity extends Monster {
        ...
        if (!this.level().isClientSide) {
            ...
            for (LivingEntity entity : this.level().getEntitiesOfClass(LivingEntity.class, damageBox)) {
                if (entity instanceof Player) {
                    ...
                    entity.addEffect(new MobEffectInstance(MobEffects.MINING_FATIGUE, 200, 0));
    ...
    public void addAdditionalSaveData(ValueOutput output) {
        ...
        output.putShort("Fuse", (short)this.getSwellTime());
    }

    @Override
    public void readAdditionalSaveData(ValueInput input) {
        super.readAdditionalSaveData(input);
        this.setSwellTime(input.getShortOr("Fuse", (short)0));
    }
